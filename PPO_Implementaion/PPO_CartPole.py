...
class ParallelEnvironments:
    def __init__(self, num_environments: int):
        ...
        self.envs = [gym.make('CartPole-v1') for _ in range(num_environments)]
...
class PPOTrainer:
    ...
    def handle_episode_end(self, environment_id: int):
        ...
        if self.episode_count % 10 == 0:
            ...
            if avg_reward >= 490:
                ...
                torch.save(self.model.state_dict(), "models/solved_model.pth")
                print(" Solved model saved to models/solved_model.pth")
                return True
        

        # if episode_reward > self.best_reward:
        #     self.best_reward = episode_reward
        #     torch.save(self.model.state_dict(), f"models/cartpole_best_model_{self.best_reward:.0f}.pth")
    ...
    def train(self):
        ...
        for iteration in range(self.configuration.max_iterations):
            ...
            if graduated:
                print("\n Training complete - CartPole SOLVED!")
        ...
        print("\n Training complete!")
        torch.save(self.model.state_dict(), "models/cartpole_final_model.pth")
    ...
    def save_training_log(self):
        ...
        with open('logs/cartpole_training_env_4.json', 'w') as f:
            json.dump(log_data, f, indent=2)
        print(" Training log saved to logs/cartpole_training.json")


def main():
    print("=" * 60)
    print("PPO for CartPole")
    print("=" * 60)
